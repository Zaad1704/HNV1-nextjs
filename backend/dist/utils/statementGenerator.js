...
exports.generateEnhancedThermalStatement = exports.generateColorfulTenantStatement = void 0;
const pdfkit_1 = __importDefault(require("pdfkit"));
const generateColorfulTenantStatement = (data, stream, language = 'en') => {
    ...
    doc.text(`$${data.payments.reduce((sum, p) => sum + p.amount, 0).toFixed(2)}`, 200, summaryY + 60);
...
exports.generateColorfulTenantStatement = generateColorfulTenantStatement;
const generateEnhancedThermalStatement = (data) => {
    const line = '--------------------------------';
    const doubleLine = '********************************';
...
Total Amount Paid: $${data.payments.reduce((sum, p) => sum + p.amount, 0).toFixed(2)}
${line}
...
exports.generateEnhancedThermalStatement = generateEnhancedThermalStatement;
