...
/**
 * Generates a colorful PDF receipt for a payment
 * @param payment The payment object
 * @param stream The writable output stream to pipe the PDF to
 * @param language The language for translations
 */
export const generateColorfulPdfReceipt = (payment: any, stream: Writable, language: string = 'en') => {
  ...
  // Organization name and receipt title
  ...
  // Payment details section with green accent
...
/**
 * Generates an enhanced thermal receipt for a payment
 * @param payment The payment object
 */
export const generateEnhancedThermalReceipt = (payment: any): string => {
  const line = '--------------------------------';
  const doubleLine = '********************************';
