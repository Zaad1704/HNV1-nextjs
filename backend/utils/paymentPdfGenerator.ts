 ...
 */
export const generatePaymentReceiptPdf = (payment: any, stream: Writable, language: string = 'en') => {
...
/**
 * Generates a payment statement PDF for a tenant
 * @param tenant The tenant object
 * @param payments Array of payment objects
 * @param stream The writable output stream to pipe the PDF to
 * @param language The language for translations
 */
export const generatePaymentStatementPdf = (tenant: any, payments: any[], stream: Writable, language: string = 'en') => {
  const doc = new PDFDocument({ 
    margin: 50,
    size: 'A4',
    info: {
