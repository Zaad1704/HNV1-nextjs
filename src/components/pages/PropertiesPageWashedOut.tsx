...
import GlassyAIInsightsWidget from '@/components/property/GlassyAIInsightsWidget';
import GlassyPropertyCard from '@/components/property/GlassyPropertyCard';
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center">
        <div className="text-center backdrop-blur-xl bg-white/10 border border-white/20 rounded-2xl p-8 shadow-2xl">
          <div className="w-16 h-16 bg-gradient-to-br from-red-500/30 to-pink-500/30 rounded-2xl flex items-center justify-center mx-auto mb-4 backdrop-blur-sm border border-red-400/30">
            <Building2 size={32} className="text-white" />
          </div>
          <h2 className="text-xl font-bold text-white mb-2">Unable to Load Properties</h2>
          <p className="text-white/70 mb-4">We're having trouble connecting to our servers.</p>
          <button 
            onClick={() => window.location.reload()}
            className="px-6 py-3 bg-gradient-to-r from-blue-500/30 to-purple-500/30 backdrop-blur-sm border border-blue-400/30 text-white rounded-xl hover:bg-blue-500/40 font-semibold transition-all duration-300"
          >
            Try Again
          </button>
        </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative">
      ...
      <div className="relative space-y-8 p-6">
        ...
        {/* Glassy Smart Suggestions Panel */}
        ...
        <div className="hidden md:block">
          <div className="phase3-desktop-layout">
            <div className="phase3-main-content space-y-6">
              ...
              {filteredProperties && filteredProperties.length > 0 ? (
                ...
                <div className="text-center py-20">
                  <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-2xl p-12 shadow-2xl max-w-lg mx-auto">
                    <div className="relative mb-8">
                      <div className="w-32 h-32 bg-gradient-to-br from-blue-500/30 to-purple-500/30 rounded-full flex items-center justify-center mx-auto shadow-2xl backdrop-blur-sm border border-white/20">
                        <Building2 size={64} className="text-white" />
                      </div>
                      <div className="absolute -top-2 -right-2 w-8 h-8 bg-gradient-to-br from-yellow-400/80 to-orange-400/80 rounded-full flex items-center justify-center shadow-lg backdrop-blur-sm">
                        <Sparkles size={16} className="text-white" />
                      </div>
                    </div>
                    <h3 className="text-3xl font-bold bg-gradient-to-r from-white to-white/80 bg-clip-text text-transparent mb-4">
            ...
            {/* Right Sidebar with Glassy AI Insights */}
            <Phase3RightSidebar
              sections={[
                createAIInsightsSection(
                  <GlassyAIInsightsWidget 
          ...
          {filteredProperties && filteredProperties.length > 0 ? (
            ...
            <div className="text-center py-20 px-4">
              <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-2xl p-8 shadow-2xl">
                <div className="relative mb-8">
                  <div className="w-24 h-24 bg-gradient-to-br from-blue-500/30 to-purple-500/30 rounded-full flex items-center justify-center mx-auto shadow-2xl backdrop-blur-sm border border-white/20">
                    <Building2 size={48} className="text-white" />
                  </div>
                  <div className="absolute -top-1 -right-1 w-6 h-6 bg-gradient-to-br from-yellow-400/80 to-orange-400/80 rounded-full flex items-center justify-center shadow-lg backdrop-blur-sm">
