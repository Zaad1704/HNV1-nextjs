...
import { DollarSign, Calendar, Download, MoreHorizontal, Building2, Users, FileText, Wallet } from 'lucide-react';

interface GlassyPaymentRadialActionWheelProps {
  onBulkPayment: () => void;
  onQuickPayment: () => void;
...
const GlassyPaymentRadialActionWheel: React.FC<GlassyPaymentRadialActionWheelProps> = ({
  onBulkPayment,
  onQuickPayment,
  onCollectionSheet,
  onExport,
                ...
                <div 
                  ...
                  style={{
                    transform: action.id === 'export' ? `translate(${x + 75}px, ${-y - 15}px)` : 
                              action.id === 'quick' ? `translate(${x + 85}px, ${-y - 15}px)` : 
...
export default GlassyPaymentRadialActionWheel;